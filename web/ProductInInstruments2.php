...
function updatesum() {
document.form.price.value = (document.form.prc.value -0) * (document.form.quantity.value -0);
}
</script>
						...
						<input type="hidden" name="entry_time" value="<?php echo date("Y-m-d h:i:s");?>" />
							<div class="modal-body">
								...
								<p>	
									...
									<span class="field">
									<select data-placeholder="Choose a Instrument" name="p_id" class="chzn-select"  style="width:487.5px;" required="" />
										<option value=""></option>
											<?php while ($row1=mysql_fetch_array($result2)) { ?>
										<option value="<?php echo $row1['id']?>"><?php echo $row1['pro_name']; ?></option>
											<?php } ?>
									</select>
										<?php if(in_array(187, $access_arry)){?><button class="btn ownbtn11" style="height: 34px; margin-top: -27px;" href="#myModal2" title="Add New Product Name" data-toggle="modal"> Add</button><?php } ?>
									</span>	
								</p>
								<p>
								...
								<p>	
									...
									<select data-placeholder="Choose a Vendor" name="vendor" class="chzn-select"  style="width:487.5px;" required="">
										...
										<?php if(in_array(188, $access_arry)){?><button class="btn ownbtn11" style="height: 34px; margin-top: -27px;" href="#myModal" title="Add New Vendor" data-toggle="modal"> Add</button><?php } ?>
									</span>	
								</p>
								<p>
									<label>Status*</label>
										<span class="field">
											<select class="chzn-select" name="p_sts" style="width:145px;" required="" >
								...
								<p>
									...
									<span class="field"><input type="text" name="prc" style="width: 135px;" required="" class="input-large" onChange="updatesum()" /></span>
								</p>
								<p>
									<label>Quantity*</label>
									<span class="field"><input type="text" name="quantity" style="width: 135px;" id="" required="" class="input-large" onChange="updatesum()" /></span>
								</p>
								<p>
									<label>Total Price</label>
									<span class="field"><input type="text" name="price" readonly style="width: 135px;" required="" placeholder="Total" class="input-large"  onChange="updatesum()" /> <b>tk</b></span>
								</p>
								<p>
									<label>Remarks</label>
