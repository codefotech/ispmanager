...
if($rx_bits >= 1024){
   ...
   $API->disconnect();
	?>
									<table class="table table-bordered" style="width: 100%; float: left;border-top: 1px solid #ddd;">
										<tr>
										...
										<tr>
											...
											<td style="padding: 0px;"><button type='submit' value='<?php echo $c_id.'&mk_id='.$mk_id;?>' class='btn ownbtn2' onClick='getRoutePointsp(this.value)' style="float: right;padding: 10px 15px;" data-placement='top' data-rel='tooltip' title='Ping again'><i class="iconfa-refresh" style="font-weight: bold;"></i></button></td>
										</tr>
									</table>
	<?php }	else{ ?>
									<table class="table table-bordered" style="width: 100%; float: left;border-top: 1px solid #ddd;">
...
else{echo 'Network are not Offline.';} ?>