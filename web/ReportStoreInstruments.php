<?php
$titel = "Store Reports (Instruments)";
$Reports = 'active';
$ReportStoreInstruments = 'activeted';
...
$query="SELECT id, pro_name, pro_details FROM product WHERE sts = '0' ORDER BY pro_name ASC";
$result=mysql_query($query);

$query2="SELECT e_id, e_name, e_des FROM emp_info WHERE status = '0' ORDER BY e_id ASC";
$result2=mysql_query($query2);

$query3="SELECT id, pro_name, pro_details FROM product WHERE sts = '0' ORDER BY pro_name ASC";
			...
			<div class="span9 rightside" style="width: 74% !important; margin-left: 15px !important;">
				<div class="box box-primary" style=" margin: 0px;">
					<div class="box-body" style="min-height: 440px;">
						<center>
						<b><h4>Instruments Store Report</h4></b><br/>
						<div class="tabbedwidget">
                            <ul>
							<?php if(in_array(167, $access_arry)){?>
                                <li><b><a href="#tabs-2">Instruments In</a></b></li>
							<?php } if(in_array(168, $access_arry)){?>
                                <li><b><a href="#tabs-3">Instruments Out</a></b></li>
							<?php } ?>
                            </ul>
							<br/><br/>
							<?php if(in_array(167, $access_arry)){?>
                            <div id="tabs-2" style="min-height: 500px;">
                                 <form id="" name="form" class="stdform" method="post" action="fpdf/ReportInstrumentsIn" target="_blank">
                            ...
                            <div id="tabs-3" style="min-height: 500px;">
                                <form id="" name="form" class="stdform" method="post" action="fpdf/ReportInstrumentsOut" target="_blank">
									<div class="inputwrapper animate_cus1">
										<select data-placeholder="Choose a Zone" name="p_id" class="chzn-select"  style="width:345px;">
												<option value="all"> All Instruments </option>
