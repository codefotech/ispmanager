...
if($t_id == 'all'){
		$query = mysql_query("SELECT CONCAT(l.z_name,' - ',l.z_bn_name) AS item, (l.TotalBill - IFNULL((t.TotalBills + t.TotalDiscount1), 0.00)) AS tot  FROM
								(
		...
		$tname = 'Due Bills Summary in All Zone';
