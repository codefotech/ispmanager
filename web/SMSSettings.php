...
$sqlsdfq = mysql_query("SELECT id, sms_msg, from_page, accpt_amount, variable, send_sts, sts, time, time_hr, time_min FROM sms_msg WHERE id= '2'");
...
$sqls1std = mysql_query("SELECT id, sms_msg, from_page, variable, send_sts, day, time_hr, time_min FROM sms_msg WHERE id= '12'");
$rows1st = mysql_fetch_assoc($sqls1std);

$sqlsdfdd = mysql_query("SELECT id, sms_msg, from_page, variable, send_sts, day, time_hr, time_min FROM sms_msg WHERE id= '13'");
						...
						<?php if($user_type == 'admin' || $user_type == 'superadmin'){?>
								...
								<div class="modal-content">
									<form id="" name="form1" class="stdform" method="post" action="AppSettingsQuery">
										...
										<div class="modal-body" style="min-height: 450px;">
											...
											<p>
												<label style="font-weight: bold;">SMS Massege*<br><a style="font-size: 10px;color: #f04a4a;margin-right: 5px;"><i>Type Text Here</i></a></label>
												<div class="span7" style="width: 45%;border-right: 1px solid #ddd;">
													<textarea type="text" name="sms_msg" style="width:88%;height: 200px;" required="" id="sms_msg" placeholder="" class="input-large" /><?php echo $rowsm['sms_msg'];?></textarea>
												</div>
											</p>
											<div class="span3" style="width: 15%;margin-left: 5%;">
												<?php echo $rowsm['variable'];?>
											</div>
										</div>
										<div class="modal-footer">
											<button type="reset" class="btn ownbtn11">Reset</button>
							...
							<div id="tabs-3" style="min-height: 500px;">
								<div class="modal-content">
									...
									<div class="modal-body" style="min-height: 500px;">
										...
										<p>
											<label style="font-weight: bold;">SMS Type</label>
											<h4 style="padding-top: 8px;font-weight: bold;">Auto</h4>
										</p><br>
										<p>
											<label style="font-weight: bold;">Service Status</label>
											<span class="formwrapper"  style="margin-left: 0px;">
												<input type="radio" name="sts" value="0" <?php if('0' == $rowsmq['sts']) echo 'checked="checked"';?>> <b style="font-size: 16px;color: green;">Active</b> &nbsp; &nbsp;
												<input type="radio" name="sts" value="1" <?php if('1' == $rowsmq['sts']) echo 'checked="checked"';?>> <b style="font-size: 16px;color: red;">Inactive</b> &nbsp; &nbsp;
											</span>
										</p>
										<p>
											<label style="font-weight: bold;line-height: 10px;">Job Run Time<br><a style="font-size: 10px;color: #f04a4a;margin-right: 5px;"><i>Will run everyday at the same time </i></a></label>
											<span class="formwrapper"  style="margin-left: 0px;"><a style="font-size: 15px;color: #f04a4a;margin-right: 5px;margin-left: 5px;">Houre</a>
												<select data-placeholder="Houre" name="time_hr" class="" style="width:40px;" required="">
													<option value="00"<?php if ('00' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">00</option>
													<option value="01"<?php if ('01' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">01</option>
													<option value="02"<?php if ('02' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">02</option>
													<option value="03"<?php if ('03' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">03</option>
													<option value="04"<?php if ('04' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">04</option>
													<option value="05"<?php if ('05' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">05</option>
													<option value="06"<?php if ('06' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">06</option>
													<option value="07"<?php if ('07' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">07</option>
													<option value="08"<?php if ('08' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">08</option>
													<option value="09"<?php if ('09' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">09</option>
													<option value="10"<?php if ('10' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">10</option>
													<option value="11"<?php if ('11' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">11</option>
													<option value="12"<?php if ('12' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">12</option>
													<option value="13"<?php if ('13' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">13</option>
													<option value="14"<?php if ('14' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">14</option>
													<option value="15"<?php if ('15' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">15</option>
													<option value="16"<?php if ('16' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">16</option>
													<option value="17"<?php if ('17' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">17</option>
													<option value="18"<?php if ('18' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">18</option>
													<option value="19"<?php if ('19' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">19</option>
													<option value="20"<?php if ('20' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">20</option>
													<option value="21"<?php if ('21' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">21</option>
													<option value="22"<?php if ('22' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">22</option>
													<option value="23"<?php if ('23' == $rowsmq['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">23</option>
												</select><a style="font-size: 18px;color: #f04a4a;margin-right: 5px;margin-left: 5px;font-weight: bold;">:</a>
												<select data-placeholder="Munite" name="time_min" class="" style="width:40px;" required="">
													<option value="00"<?php if ('00' == $rowsmq['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">00</option>
													<option value="05"<?php if ('05' == $rowsmq['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">05</option>
													<option value="10"<?php if ('10' == $rowsmq['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">10</option>
													<option value="15"<?php if ('15' == $rowsmq['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">15</option>
													<option value="20"<?php if ('20' == $rowsmq['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">20</option>
													<option value="25"<?php if ('25' == $rowsmq['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">25</option>
													<option value="30"<?php if ('30' == $rowsmq['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">30</option>
													<option value="35"<?php if ('35' == $rowsmq['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">35</option>
													<option value="40"<?php if ('40' == $rowsmq['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">40</option>
													<option value="45"<?php if ('45' == $rowsmq['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">45</option>
													<option value="50"<?php if ('50' == $rowsmq['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">50</option>
													<option value="55"<?php if ('55' == $rowsmq['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">55</option>
												</select><a style="font-size: 15px;color: #f04a4a;margin-left: 5px;">Minute</a>
											</span>
										</p>
										<p>
											<label style="font-weight: bold;line-height: 10px;">Minimum Due Amount<br><a style="font-size: 10px;color: #f04a4a;margin-right: 5px;"><i>When Due Amount Larger Than <?php echo $rowsmq['accpt_amount'].'TK';?></i></a></label>
											<span class="field" style="font-weight: bold;"><input type="text" name="accpt_amount" id="" style="width: 50px;" required="" value="<?php echo $rowsmq['accpt_amount'];?>"/> TK</span>
										</p>
										<br>
										<p>
											<label style="font-weight: bold;">Send SMS?</label>
											<span class="formwrapper"  style="margin-left: 0px;">
										...
										<p>
											<label style="font-weight: bold;">SMS Massege*</label>
											<div class="span7" style="width: 45%;border-right: 1px solid #ddd;margin-left: 0;">
												<textarea type="text" name="sms_msg" style="width:88%;height: 200px;" required="" id="sms_msg" placeholder="" class="input-large" /><?php echo $rowsmq['sms_msg'];?></textarea>
											</div>
										</p>
										<div class="span3" style="width: 15%;margin-left: 5%;">
											<?php echo $rowsmq['variable'];?>
										</div>
									</div>
									<br>
									<div class="modal-footer">
								...
								<div class="modal-content">
									...
									<input type="hidden" name="z_id" value=""/>
										...
										<p>
											<label style="font-weight: bold;">SMS Massege*<br><a style="font-size: 10px;color: #f04a4a;margin-right: 5px;"><i>Type Text Here</i></a></label>
											<div class="span7" style="width: 45%;border-right: 1px solid #ddd;">
												<textarea type="text" name="sms_msg" style="width:88%;height: 200px;" required="" id="sms_msg" placeholder="" class="input-large" /><?php echo $rowsme['sms_msg'];?></textarea>
											</div>
										</p>
										<div class="span3" style="width: 15%;margin-left: 5%;">
											<?php echo $rowsme['variable'];?>
										</div>
									</div>
									<div class="modal-footer">
										<button type="reset" class="btn ownbtn11">Reset</button>
							...
							<div id="tabs-5" style="min-height: 500px;">
								<div class="modal-content">
									...
									<input type="hidden" name="z_id" value=""/>
									<div class="modal-body" style="min-height: 550px;border-bottom: 1px solid #ddd;">
										<p>
										...
										<p>
											<label style="font-weight: bold;">SMS Massege*<br><a style="font-size: 10px;color: #f04a4a;margin-right: 5px;"><i>Type Text Here</i></a></label>
											<div class="span7" style="width: 45%;border-right: 1px solid #ddd;">
												<textarea type="text" name="sms_msg" style="width:88%;height: 350px;" required="" id="sms_msg" placeholder="" class="input-large" /><?php echo $rowsmep['sms_msg'];?></textarea>
											</div>
										</p>
										<div class="span3" style="width: 15%;margin-left: 5%;">
											<?php echo $rowsmep['variable'];?>
										</div>
									</div>
									...
									<div class="modal-body">
										...
										<table style="width: 100%;">
											 <tr>
												<th style="width: 60%;">
													<p>
														<label style="font-weight: bold;">SMS Massege*<br><a style="font-size: 10px;color: #f04a4a;margin-right: 5px;"><i>For Employee</i></a></label>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<p>
											<label style="font-weight: bold;line-height: 10px;">Job Run Time<br><a style="font-size: 10px;color: #f04a4a;margin-right: 5px;"><i>Will run everyday at the same time </i></a></label>
											<span class="formwrapper"  style="margin-left: 0px;"><a style="font-size: 15px;color: #f04a4a;margin-right: 5px;margin-left: 5px;">Houre</a>
												<select data-placeholder="Houre" name="time_hr_1" class="" style="width:40px;" required="">
													<option value="00"<?php if ('00' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">00</option>
													<option value="01"<?php if ('01' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">01</option>
													<option value="02"<?php if ('02' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">02</option>
													<option value="03"<?php if ('03' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">03</option>
													<option value="04"<?php if ('04' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">04</option>
													<option value="05"<?php if ('05' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">05</option>
													<option value="06"<?php if ('06' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">06</option>
													<option value="07"<?php if ('07' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">07</option>
													<option value="08"<?php if ('08' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">08</option>
													<option value="09"<?php if ('09' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">09</option>
													<option value="10"<?php if ('10' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">10</option>
													<option value="11"<?php if ('11' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">11</option>
													<option value="12"<?php if ('12' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">12</option>
													<option value="13"<?php if ('13' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">13</option>
													<option value="14"<?php if ('14' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">14</option>
													<option value="15"<?php if ('15' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">15</option>
													<option value="16"<?php if ('16' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">16</option>
													<option value="17"<?php if ('17' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">17</option>
													<option value="18"<?php if ('18' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">18</option>
													<option value="19"<?php if ('19' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">19</option>
													<option value="20"<?php if ('20' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">20</option>
													<option value="21"<?php if ('21' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">21</option>
													<option value="22"<?php if ('22' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">22</option>
													<option value="23"<?php if ('23' == $rows1st['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">23</option>
												</select><a style="font-size: 18px;color: #f04a4a;margin-right: 5px;margin-left: 5px;font-weight: bold;">:</a>
												<select data-placeholder="Munite" name="time_min_1" class="" style="width:40px;" required="">
													<option value="00"<?php if ('00' == $rows1st['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">00</option>
													<option value="05"<?php if ('05' == $rows1st['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">05</option>
													<option value="10"<?php if ('10' == $rows1st['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">10</option>
													<option value="15"<?php if ('15' == $rows1st['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">15</option>
													<option value="20"<?php if ('20' == $rows1st['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">20</option>
													<option value="25"<?php if ('25' == $rows1st['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">25</option>
													<option value="30"<?php if ('30' == $rows1st['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">30</option>
													<option value="35"<?php if ('35' == $rows1st['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">35</option>
													<option value="40"<?php if ('40' == $rows1st['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">40</option>
													<option value="45"<?php if ('45' == $rows1st['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">45</option>
													<option value="50"<?php if ('50' == $rows1st['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">50</option>
													<option value="55"<?php if ('55' == $rows1st['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">55</option>
												</select><a style="font-size: 15px;color: #f04a4a;margin-left: 5px;">Minute</a>
											</span>
										</p>
										<p>
									...
									<input type="hidden" name="sms_id_2" value="<?php echo $rowsmdd['id'];?>"/>
										...
										<p>
											<label style="font-weight: bold;line-height: 10px;">Job Run Time<br><a style="font-size: 10px;color: #f04a4a;margin-right: 5px;"><i>Will run everyday at the same time </i></a></label>
											<span class="formwrapper"  style="margin-left: 0px;"><a style="font-size: 15px;color: #f04a4a;margin-right: 5px;margin-left: 5px;">Houre</a>
												<select data-placeholder="Houre" name="time_hr_2" class="" style="width:40px;" required="">
													<option value="00"<?php if ('00' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">00</option>
													<option value="01"<?php if ('01' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">01</option>
													<option value="02"<?php if ('02' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">02</option>
													<option value="03"<?php if ('03' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">03</option>
													<option value="04"<?php if ('04' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">04</option>
													<option value="05"<?php if ('05' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">05</option>
													<option value="06"<?php if ('06' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">06</option>
													<option value="07"<?php if ('07' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">07</option>
													<option value="08"<?php if ('08' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">08</option>
													<option value="09"<?php if ('09' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">09</option>
													<option value="10"<?php if ('10' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">10</option>
													<option value="11"<?php if ('11' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">11</option>
													<option value="12"<?php if ('12' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">12</option>
													<option value="13"<?php if ('13' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">13</option>
													<option value="14"<?php if ('14' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">14</option>
													<option value="15"<?php if ('15' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">15</option>
													<option value="16"<?php if ('16' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">16</option>
													<option value="17"<?php if ('17' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">17</option>
													<option value="18"<?php if ('18' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">18</option>
													<option value="19"<?php if ('19' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">19</option>
													<option value="20"<?php if ('20' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">20</option>
													<option value="21"<?php if ('21' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">21</option>
													<option value="22"<?php if ('22' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">22</option>
													<option value="23"<?php if ('23' == $rowsmdd['time_hr']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">23</option>
												</select><a style="font-size: 18px;color: #f04a4a;margin-right: 5px;margin-left: 5px;font-weight: bold;">:</a>
												<select data-placeholder="Munite" name="time_min_2" class="" style="width:40px;" required="">
													<option value="00"<?php if ('00' == $rowsmdd['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">00</option>
													<option value="05"<?php if ('05' == $rowsmdd['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">05</option>
													<option value="10"<?php if ('10' == $rowsmdd['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">10</option>
													<option value="15"<?php if ('15' == $rowsmdd['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">15</option>
													<option value="20"<?php if ('20' == $rowsmdd['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">20</option>
													<option value="25"<?php if ('25' == $rowsmdd['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">25</option>
													<option value="30"<?php if ('30' == $rowsmdd['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">30</option>
													<option value="35"<?php if ('35' == $rowsmdd['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">35</option>
													<option value="40"<?php if ('40' == $rowsmdd['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">40</option>
													<option value="45"<?php if ('45' == $rowsmdd['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">45</option>
													<option value="50"<?php if ('50' == $rowsmdd['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">50</option>
													<option value="55"<?php if ('55' == $rowsmdd['time_min']) echo 'selected="selected"';?> style="text-align: center;font-weight: bold;">55</option>
												</select><a style="font-size: 15px;color: #f04a4a;margin-left: 5px;">Minute</a>
											</span>
										</p>
										<p>
