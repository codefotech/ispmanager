...
$que = mysql_query("SELECT c.con_sts, c.mk_id, c.p_id, c.mac_user, p.p_price, p.mk_profile FROM clients as c LEFT JOIN package as p ON p.p_id = c.p_id WHERE c.c_id = '$c_id'");
