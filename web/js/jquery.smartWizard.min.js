  ...
  a.fn.smartWizard = function(k) {
    ...
    return this.each(function() {
      ...
      function t(d) {
        ...
        if (d != h && a.isFunction(c.onLeaveStep) && !c.onLeaveStep.call(this, a(g)))
          return !1;

        m.height(a(a(e, b).attr("href"), b).outerHeight());
        
        if (c.transitionEffect == "slide") {
          a(a(g, b).attr("href"), b).slideUp("fast", function() {
            a(a(e, b).attr("href"), b).slideDown("fast");
            h = d;
            r(g, e);
          });
        } else if (c.transitionEffect == "fade") {
          a(a(g, b).attr("href"), b).fadeOut("fast", function() {
          ...
          if (d > h) {
            nextElmLeft1 = w + 10;
            nextElmLeft2 = 0;
            i = 0 - a(a(g, b).attr("href"), b).outerWidth();
          } else {
            nextElmLeft1 = 0 - a(a(e, b).attr("href"), b).outerWidth() + 20;
            nextElmLeft2 = 0;
            i = 10 + a(a(g, b).attr("href"), b).outerWidth();
          }
          
          if (d == h) {
            nextElmLeft1 = a(a(e, b).attr("href"), b).outerWidth() + 20;
            nextElmLeft2 = 0;
            i = 0 - a(a(g, b).attr("href"), b).outerWidth();
          }
      ...
      function r(d, e) {
        ...
        if (!f.hasClass("disabled") || c.enableFinishButton)
          a(p).removeClass("buttonDisabled");
        else
          a(p).addClass("buttonDisabled");
      ...
      if (j.length == 0)
        j = a('<div class="msgBox"><div class="content"></div><a href="#" class="close">X</a></div>').appendTo(i);
