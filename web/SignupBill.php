...
$access1 = mysql_query("SELECT * FROM module_page WHERE parent_id = '25' AND $user_type in (1,2)");
if(mysql_num_rows($access) > 0 && mysql_num_rows($access1) > 0){
//---------- Permission -----------
ini_alter('date.timezone','Asia/Almaty');
$this_month_yr = date('Y-m', time());

if(in_array(211, $access_arry)){
	if($user_type == 'billing'){
		...
		(SELECT b.id, c.c_id, bn.sort_name, b.bill_type, q.type, c.c_name, b.pay_date, b.amount, e.e_name AS billentryby, c.cell, 'signup' AS ww, b.pay_date_time, b.bill_dsc FROM bill_signup AS b
								...
								WHERE FIND_IN_SET('$e_id', z.emp_id) > 0
		UNION
...
if($user_type == 'billing') {
$queryr = mysql_query("SELECT c.c_id, c.com_id, c.c_name, c.cell FROM clients AS c LEFT JOIN zone AS z ON z.z_id = c.z_id WHERE FIND_IN_SET('$e_id', z.emp_id) > 0 ORDER BY com_id DESC");
}
else{
$queryr = mysql_query("SELECT c_id, com_id, c_name, cell FROM clients ORDER BY com_id DESC");
}
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="popdiv">
						<div class="col-1" style="font-weight: bold;">Choose Client* </div>
						<div class="col-2"> 
					...
					<div class="popdiv">
						<div class="col-1" style="font-weight: bold;">Bill Type*</div>
						<div class="col-2">
					...
					<div class="popdiv">
						<div class="col-1" style="font-weight: bold;">Bank*</div>
						<div class="col-2">
					...
					<div class="popdiv">
						<div class="col-1" style="font-weight: bold;">Amount* </div>
						<div class="col-2"> 
							<input type="text" name="amount" id="" required="" style="width: 100px;height: 25px;font-size: 20px;font-weight: bold;color: brown;text-align: center;" /><input type="text" value="৳" readonly style="width:17px;height: 25px; color:brown; font-weight: bold;font-size: 20px;border-left: none;" />
						</div>
					</div>
					<div class="popdiv">
...
<div aria-hidden="false" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal hide fade in" id="myModal20">
	...
	<div class="pageheader">
		...
		<?php } if(in_array(213, $access_arry)){?>
			<a class="btn ownbtn1" href="#myModal" data-toggle="modal">Add For Client </a>
		<?php } if(in_array(214, $access_arry)){?>
			<a class="btn ownbtn2" href="#myModal10" data-toggle="modal">Add Extra Income </a>
		<?php } ?>
        </div>
