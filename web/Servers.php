...
?>
	<div class="pageheader">
		...
		<?php if($user_type == 'client' || $user_type == 'breseller'){ } else{ ?>
			<a class="btn btn-primary" href="ServersAdd"><i class="iconfa-plus"></i> Add</a>
		<?php } ?>
        </div>
        <div class="pageicon"><i class="iconfa-facetime-video"></i></div>
        <div class="pagetitle">
            <h1>FTP & TV Servers</h1>
        </div>
		...
		<div class="box box-primary">
			...
			<div style="width: 45%;float: left;padding: 2% 0% 0% 3%;">
				<div class="box-header">
					<a style="font-size: 20px;color: #6d6e72;font-weight: bold;">FTP Servers List</a>
				</div>
				<div class="box-body" style="border-right: 3px solid #d2d2d2;">
			...
			<div style="width: 45%;float: left;padding: 3% 0% 0% 3%;">
			<div class="box-header">
				<a style="font-size: 20px;color: #6d6e72;font-weight: bold;">TV Servers List</a>
			</div>
			<div class="box-body">
