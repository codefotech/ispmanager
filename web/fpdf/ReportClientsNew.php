...
if($z_id == 'allzone')
{
			...
			$pdf->SetXY(30, 8);
			$pdf->AddCol('join_date',15,'Joining','L');
			$pdf->AddCol('c_id',24,'Clint ID','L');
			$pdf->AddCol('c_name',25,'Clint Name','L');
			$pdf->AddCol('z_name',40,'Zone','L');
			$pdf->AddCol('address',45,'Address','L');
			$pdf->AddCol('cell',20,'Cell','L');
			$pdf->AddCol('p_name',20,'Package','L');
			$pdf->AddCol('bandwith',13,'Bandwith','L');
