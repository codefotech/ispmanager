...
if($con_sts == ''){
	if($z_id == 'all' && $p_m == ''){
	$result = mysql_query("SELECT t1.c_id, t1.con_sts, t1.c_name, t1.com_id, t1.address, t1.note, t1.join_date, t1.cell, t1.p_price, t1.b_name AS z_name, IFNULL(t2.dis,0.00) AS dis, IFNULL(t2.billl,0.00) AS bill, IFNULL(t3.bill_disc,0.00) AS bill_disc, t1.p_m, IFNULL(t3.pay, 0.00) AS pay FROM
									(
									SELECT c.c_id, c.c_name, c.com_id, c.address, c.cell, c.join_date, c.p_id, p.p_price, z.z_name, b.b_name, c.note, c.p_m, c.con_sts FROM clients AS c 
									LEFT JOIN package AS p ON c.p_id = p.p_id
									LEFT JOIN zone AS z ON z.z_id = c.z_id 
									LEFT JOIN box AS b ON b.box_id = c.box_id 
									WHERE c.mac_user = '1' AND c.sts != '1' AND c.z_id = '$resellerzone'
									ORDER BY c.z_id ASC
									)t1
									LEFT JOIN
									(
									SELECT b.c_id, SUM(b.bill_amount) AS billl, SUM(b.discount) AS dis FROM billing_mac_client AS b
	...
	if($z_id == 'all' && $p_m != ''){
	$result = mysql_query("SELECT t1.c_id, t1.con_sts, t1.c_name, t1.com_id, t1.address, t1.join_date, t1.note, t1.cell, t1.p_price, t1.b_name AS z_name, IFNULL(t2.dis,0.00) AS dis, IFNULL(t2.billl,0.00) AS bill, IFNULL(t3.bill_disc,0.00) AS bill_disc, t1.p_m, IFNULL(t3.pay, 0.00) AS pay FROM
									(
									SELECT c.c_id, c.c_name, c.com_id, c.address, c.cell, c.join_date, c.p_id, p.p_price, z.z_name, b.b_name, c.note, c.p_m, c.con_sts FROM clients AS c 
									LEFT JOIN package AS p ON c.p_id = p.p_id
									LEFT JOIN zone AS z ON z.z_id = c.z_id 
									LEFT JOIN box AS b ON b.box_id = c.box_id 
									WHERE c.mac_user = '1' AND c.p_m = '$p_m' AND c.sts != '1' AND c.z_id = '$resellerzone' ORDER BY c.z_id ASC
									)t1
									LEFT JOIN
									(
									SELECT b.c_id, SUM(b.bill_amount) AS billl, SUM(b.discount) AS dis FROM billing_mac_client AS b
	...
	$result = mysql_query("SELECT t1.c_id, t1.con_sts, t1.c_name, t1.com_id, t1.join_date, t1.address, t1.note, t1.cell, t1.p_price, t1.b_name AS z_name, IFNULL(t2.dis,0.00) AS dis, IFNULL(t2.billl,0.00) AS bill, IFNULL(t3.bill_disc,0.00) AS bill_disc, t1.p_m, IFNULL(t3.pay, 0.00) AS pay FROM
									(
									SELECT c.c_id, c.c_name, c.com_id, c.address, c.cell, c.join_date, c.p_id, p.p_price, z.z_name, b.b_name, c.note, c.p_m, c.con_sts FROM clients AS c 
									LEFT JOIN package AS p ON c.p_id = p.p_id
									LEFT JOIN zone AS z ON z.z_id = c.z_id 
									LEFT JOIN box AS b ON b.box_id = c.box_id 
									WHERE c.mac_user = '1' AND c.p_m = '$p_m' AND c.box_id = '$z_id' AND c.z_id = '$resellerzone' AND c.sts != '1' ORDER BY c.z_id ASC
									)t1
									LEFT JOIN
									(
									SELECT b.c_id, SUM(b.bill_amount) AS billl, SUM(b.discount) AS dis FROM billing_mac_client AS b
	...
	$result = mysql_query("SELECT t1.c_id, t1.con_sts, t1.c_name, t1.com_id, t1.join_date, t1.address, t1.note, t1.cell, t1.p_price, t1.b_name AS z_name, IFNULL(t2.dis,0.00) AS dis, IFNULL(t2.billl,0.00) AS bill, IFNULL(t3.bill_disc,0.00) AS bill_disc, t1.p_m, IFNULL(t3.pay, 0.00) AS pay FROM
									...
									LEFT JOIN zone AS z ON z.z_id = c.z_id 
									LEFT JOIN box AS b ON b.box_id = c.box_id 
									WHERE c.mac_user = '1' AND c.box_id = '$z_id' AND c.sts != '1' AND c.z_id = '$resellerzone' ORDER BY c.z_id ASC
									)t1
									LEFT JOIN
									(
									SELECT b.c_id, SUM(b.bill_amount) AS billl, SUM(b.discount) AS dis FROM billing_mac_client AS b
...
if($con_sts == 'Active' || $con_sts == 'Inactive'){
	if($z_id == 'all' && $p_m == ''){
	$result = mysql_query("SELECT t1.c_id, t1.con_sts, t1.c_name, t1.com_id, t1.join_date, t1.address, t1.note, t1.cell, t1.p_price, t1.b_name AS z_name, IFNULL(t2.dis,0.00) AS dis, IFNULL(t2.billl,0.00) AS bill, IFNULL(t3.bill_disc,0.00) AS bill_disc, t1.p_m, IFNULL(t3.pay, 0.00) AS pay FROM
									(
									SELECT c.c_id, c.c_name, c.com_id, c.address, c.cell, c.join_date, c.p_id, p.p_price, z.z_name, b.b_name, c.note, c.p_m, c.con_sts FROM clients AS c 
									...
									LEFT JOIN zone AS z ON z.z_id = c.z_id 
									LEFT JOIN box AS b ON b.box_id = c.box_id 
									WHERE c.mac_user = '1' AND c.con_sts = '$con_sts' AND c.sts != '1' AND c.z_id = '$resellerzone' ORDER BY c.z_id ASC
									)t1
									LEFT JOIN
									(
									SELECT b.c_id, SUM(b.bill_amount) AS billl, SUM(b.discount) AS dis FROM billing_mac_client AS b
	...
	$result = mysql_query("SELECT t1.c_id, t1.con_sts, t1.c_name, t1.com_id, t1.join_date, t1.address, t1.note, t1.cell, t1.p_price, t1.b_name AS z_name, IFNULL(t2.dis,0.00) AS dis, IFNULL(t2.billl,0.00) AS bill, IFNULL(t3.bill_disc,0.00) AS bill_disc, t1.p_m, IFNULL(t3.pay, 0.00) AS pay FROM
									...
									LEFT JOIN zone AS z ON z.z_id = c.z_id 
									LEFT JOIN box AS b ON b.box_id = c.box_id 
									WHERE c.mac_user = '1' AND c.p_m = '$p_m' AND c.con_sts = '$con_sts' AND c.z_id = '$resellerzone' AND c.sts != '1' ORDER BY c.z_id ASC
									)t1
									LEFT JOIN
									(
									SELECT b.c_id, SUM(b.bill_amount) AS billl, SUM(b.discount) AS dis FROM billing_mac_client AS b
	...
	$result = mysql_query("SELECT t1.c_id, t1.con_sts, t1.c_name, t1.com_id, t1.join_date, t1.address, t1.note, t1.cell, t1.p_price, t1.b_name AS z_name, IFNULL(t2.dis,0.00) AS dis, IFNULL(t2.billl,0.00) AS bill, IFNULL(t3.bill_disc,0.00) AS bill_disc, t1.p_m, IFNULL(t3.pay, 0.00) AS pay FROM
									...
									LEFT JOIN zone AS z ON z.z_id = c.z_id 
									LEFT JOIN box AS b ON b.box_id = c.box_id 
									WHERE c.mac_user = '1' AND c.p_m = '$p_m' AND c.box_id = '$z_id' AND c.z_id = '$resellerzone' AND c.con_sts = '$con_sts' AND c.sts != '1' ORDER BY c.z_id ASC
									)t1
									LEFT JOIN
									(
									SELECT b.c_id, SUM(b.bill_amount) AS billl, SUM(b.discount) AS dis FROM billing_mac_client AS b
	...
	$result = mysql_query("SELECT t1.c_id, t1.con_sts, t1.c_name, t1.com_id, t1.join_date, t1.address, t1.note, t1.cell, t1.p_price, t1.b_name AS z_name, IFNULL(t2.dis,0.00) AS dis, IFNULL(t2.billl,0.00) AS bill, IFNULL(t3.bill_disc,0.00) AS bill_disc, t1.p_m, IFNULL(t3.pay, 0.00) AS pay FROM
									...
									WHERE c.mac_user = '1' AND c.box_id = '$z_id' AND c.con_sts = '$con_sts' AND c.z_id = '$resellerzone' AND c.sts != '1' ORDER BY c.z_id ASC
									)t1
									LEFT JOIN
									(
									SELECT b.c_id, SUM(b.bill_amount) AS billl, SUM(b.discount) AS dis FROM billing_mac_client AS b
...
if($withlogo == 'Yes'){
		...
		$pdf->SetFont('Helvetica','',8);
		$pdf->Cell(2,5,'','0',0,'L',false);
		$pdf->Cell(67,3,$com_id,'0',0,'L',false);
		$pdf->Cell(1,3,'Vat : ','0',0,'R',false);
		$pdf->Cell(12,3,'0.00','B',0,'R',false);
		$pdf->Cell(5,3,'','0',0,'L',false);
		$pdf->Cell(73,3,$com_id,'0',0,'L',false);
