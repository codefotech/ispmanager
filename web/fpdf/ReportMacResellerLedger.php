...
$e_name = $rowz['e_name'];
	...
	class PDF extends PDF_MySQL_Table
		...
		$result = mysql_query("SELECT a.entry_date, a.pay_time, a.totalclients, a.totalbill, a.opening_balance, a.pay_amount, a.pay_mode, a.discount, a.closing_balance FROM
								(SELECT  b.entry_date, COUNT(b.c_id) totalclients, SUM(b.bill_amount) AS totalbill, '-' AS pay_time, '-' AS pay_mode, '-' AS discount, '-' AS opening_balance, '-' AS closing_balance, '-' AS pay_amount FROM billing_mac AS b
								LEFT JOIN clients AS c
								ON c.c_id = b.c_id
								WHERE c.mac_user = '1' AND c.z_id = '$z_id' GROUP BY MONTH(b.entry_date), YEAR(b.entry_date)
								UNION
