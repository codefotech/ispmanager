	...
	if ($position != '')
	{
		...
		if($result1) 
		{
            if(mysql_num_rows($result1) > 0) {
					...
					//	$queryss = ("insert into login_cookie (user_name, e_id, user_id, ip, browser, user_type, cookie, login_count, expired_at, device) VALUES ('$u_name', '$u_e_id', '$u_id', '$ip', '$browser', '$u_type', '$fghjdfgh', '1', '$days', 'Desktop')");
