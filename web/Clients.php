...
if($user_type == 'admin' || $user_type == 'superadmin' || $user_type == 'support' || $user_type == 'accounts' || $user_type == 'billing_manager' || $user_type == 'billing' || $user_type == 'support_manager' || $user_type == 'ets'){
						if($type == 'all' && in_array(114, $access_arry)){
							$allclients = "SELECT *, m.id as mk_id, c.z_id as zoneiddd, c.note AS notee FROM clients AS c
...
<div aria-hidden="false" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal hide fade in" id="myModal345345">
	...
	<div class="pageheader">
		...
		<?php if($user_type == 'admin' || $user_type == 'superadmin' || $user_type == 'support' || $userr_typ == 'mreseller' || $user_type == 'accounts' || $user_type == 'billing' || $user_type == 'billing_manager' || $user_type == 'support_manager' || $user_type == 'ets'){ ?>
			...
			<?php if($user_type == 'admin' || $user_type == 'superadmin'){ if($type == 'auto'){?>
				<a class="btn" style="border-radius: 3px;border: 1px solid red;color: red;padding: 5px 8px;font-size: 17px;margin-right: 2px;margin-left: -3px;" href="cron_auto_inactive" title='Run Auto Inactive Job Now'><i class="iconfa-stop"></i></a>
				<?php } ?>
				...
				<table id="dyntable2" class="table table-bordered responsive">
                   ...
                   <thead>
						...
						<?php if($minimize_data_load == '0'){ if($userr_typ == 'mreseller'){ ?>
							...
							<?php if($type != 'recharge' && $client_onlineclient_sts == '1'){ ?><th class="head1" style="width: 15%;">Online Info<?php } ?></th>
						...
						<?php } else{ if($type == 'macclient'){?>
							...
							<th class="head0 center">Termination Date</th>
							<th class="head1 center">Remaining</th>
							<?php if($client_onlineclient_sts == '1'){ ?><th class="head1" style="width: 15%;">Online Info<?php } ?></th>
							<th class="head1 center">Status</th>
                    ...
                    <tbody>
						<?php
								...
								if($row['note_auto'] != '' || $row['notee'] != ''){
									$note_auto_note = "<div class='btn-group' style='margin: 7px 0 0 0;'><ul class='popoversample'><li style='margin-right: 0px;'><form href='#myModal11' data-toggle='modal'><button class='btn' type='submit' value='".$row['c_id']."' style='border: 0px;font-size: 15px; background: none;color: purple;padding: 8px 10px 8px;margin-top: 7px;' title='Note' onClick='getRoutePoint1(this.value)'><i class='iconfa-warning-sign'></i></button></form></ul></div>";
								}
								else{
									$note_auto_note = "";
								}
...
//										$clientactive = "<button style='border-radius: 3px;text-transform: uppercase;font-family: RobotoLight, Helvetica Neue, Helvetica, sans-serif;border: 1px solid red;color: red;font-size: 12px;margin-top: 2px;padding: 3px 8px 3px;' class='btn'>Offline</button>";
									...
									if($diff <= '7'){
										...
										$colorrrraa = 'style="vertical-align: middle;color: red;font-size: 15px;font-weight: bold;padding: 0px;min-width: 70px;"'; 
									}
									else{
										...
										$colorrrraa = 'style="vertical-align: middle;color: #0866c6;font-size: 15px;font-weight: bold;padding: 0px;min-width: 70px;"'; 
									}
									}
									else{
										$enddate = '';
								...
								if(in_array(104, $access_arry)){
									$clientview = "<li style='margin-bottom: 2px;'><form action='ClientView' method='post' target='_blank'><input type='hidden' name='ids' value='".$row['c_id']."' /><button style='border-top: 1px solid #80808040;color: #0866c6;border-bottom: 1px solid #80808040;width: 160px;border-left: 1px solid #80808040;border-right: 1px solid #80808040;text-align: left;padding: 3px 0 3px 8px;font-size: 14px;' title='Profile'><i class='iconfa-eye-open'></i>&nbsp;&nbsp;&nbsp;Profile</button></form></li>";
								} 
								if(in_array(101, $access_arry)){
									if($userr_typ == 'mreseller'){$fghfgh = 'ClientEdit';} else{$fghfgh = 'ClientEdit';}
									$clientedit = "<li style='margin-bottom: 2px;'><form action='".$fghfgh."' method='post' target='_blank'><input type='hidden' name='c_id' value='".$row['c_id']."' /><button style='border-top: 1px solid #80808040;color: #a0f;border-bottom: 1px solid #80808040;width: 160px;border-left: 1px solid #80808040;border-right: 1px solid #80808040;text-align: left;padding: 3px 0 3px 8px;font-size: 14px;' title='Edit'><i class='iconfa-edit'></i>&nbsp;&nbsp;&nbsp;Edit</button></form></li>";
								}
								if(in_array(105, $access_arry)){
									$clientsms = "<li style='margin-bottom: 2px;'><form action='ClientSMS' method='post' target='_blank'><input type='hidden' name='ids' value='".$row['c_id']."' /><button style='border-top: 1px solid #80808040;color: green;border-bottom: 1px solid #80808040;width: 160px;border-left: 1px solid #80808040;border-right: 1px solid #80808040;text-align: left;padding: 3px 0 3px 8px;font-size: 14px;' title='Send SMS'><i class='iconfa-envelope'></i>&nbsp;&nbsp;&nbsp;Send SMS</button></form></li>";
								}
								if($row['con_sts'] == 'Active'){
									$packcng = "<li style='margin-bottom: 2px;'>{$monthlyinv}</li>";
								...
								if(in_array(128, $access_arry)){
									$cashpaymentadd = "<li style='margin-bottom: 2px;'><form action='PaymentAdd' method='post' target='_blank'><input type='hidden' name='c_id' value='".$row['c_id']."' /><button style='border-top: 1px solid #80808040;color: #044a8e;border-bottom: 1px solid #80808040;width: 160px;border-left: 1px solid #80808040;border-right: 1px solid #80808040;text-align: left;padding: 3px 0 3px 8px;font-size: 14px;' title='Cash Payment'><i class='iconfa-money'></i>&nbsp;&nbsp;&nbsp;Cash Payment</button></form></li>";
								}
								if(in_array(129, $access_arry)){
									$onlinepaymentadd = "<li style='margin-bottom: 2px;'><form action='PaymentOnlineAdd' method='post' target='_blank'><input type='hidden' name='c_id' value='".$row['c_id']."' /><button style='border-top: 1px solid #80808040;color: green;border-bottom: 1px solid #80808040;width: 160px;border-left: 1px solid #80808040;border-right: 1px solid #80808040;text-align: left;padding: 3px 0 3px 8px;font-size: 14px;' title='Online Payment'><i class='iconfa-shopping-cart'></i>&nbsp;&nbsp;&nbsp;Online Payment</button></form></li>";
								}
								if($userr_typ == 'mreseller'){
									$mrclientsrecharge = "<li style='margin-bottom: 2px;'><form action='ClientsRecharge' method='post' target='_blank'><input type='hidden' name='c_id' value='".$row['c_id']."' /><button style='border-top: 1px solid #80808040;color: #2ab105;border-bottom: 1px solid #80808040;width: 160px;border-left: 1px solid #80808040;border-right: 1px solid #80808040;text-align: left;padding: 3px 0 3px 8px;font-size: 14px;' title='Recharge'><i class='iconfa-globe'></i>&nbsp;&nbsp;&nbsp;Recharge</button></form></li>";
								}
								if(in_array(107, $access_arry)){
									$mrclientsrechargeee = "<li style='margin-bottom: 2px;'><form action='ClientsRecharge' method='post' target='_blank'><input type='hidden' name='c_id' value='".$row['c_id']."' /><button style='border-top: 1px solid #80808040;color: #2ab105;border-bottom: 1px solid #80808040;width: 160px;border-left: 1px solid #80808040;border-right: 1px solid #80808040;text-align: left;padding: 3px 0 3px 8px;font-size: 14px;' title='Recharge'><i class='iconfa-globe'></i>&nbsp;&nbsp;&nbsp;Recharge</button></form></li>";
								}
								if(in_array(106, $access_arry) && $minimize_data_load == '0'){
									$clientlockk = "<li style='margin-bottom: 2px;'><form action='ClientLock' method='post' target='_blank'><input type='hidden' name='id' value='".$row['c_id']."' /><button onclick='return checkLock()' style='border-top: 1px solid #80808040;".$www1."border-bottom: 1px solid #80808040;width: 160px;border-left: 1px solid #80808040;border-right: 1px solid #80808040;text-align: left;padding: 3px 0 3px 8px;font-size: 14px;'>".$bb."&nbsp;&nbsp;&nbsp;".$cc."</button></form></li>";
								}
								if(in_array(102, $access_arry)){
									$dlientdelete = "<li style='margin-bottom: 2px;'><form action='ClientDelete' method='post'><input type='hidden' name='c_id' value='".$row['c_id']."' /><input type='hidden' name='breseller' value='".$row['breseller']."'/><button onclick='return checkDelete()' style='border-top: 1px solid #80808040;color: red;border-bottom: 1px solid #80808040;width: 160px;border-left: 1px solid #80808040;border-right: 1px solid #80808040;text-align: left;padding: 3px 0 3px 8px;font-size: 14px;' title='Delete'><i class='iconfa-trash'></i>&nbsp;&nbsp;&nbsp;Delete</button></form></li>";
								}
								if(in_array(108, $access_arry)){
									$clientdeleteretarn = "<li style='margin-bottom: 2px;'><form action='ClientDeleteRetarn' method='post' target='_blank' method='post' title='Restore'><input type='hidden' name='c_id' value='".$row['c_id']."' /><input type='hidden' name='c_name' value='".$row['c_name']."' /><input type='hidden' name='cell' value='".$row['cell']."' /><input type='hidden' name='bname' value='".$row['b_name']."' /><input type='hidden' name='address' value='".$row['address']."' /><input type='hidden' name='join_date' value='".$row['join_date']."' /><button style='border-top: 1px solid #80808040;color: #b76700;border-bottom: 1px solid #80808040;width: 160px;border-left: 1px solid #80808040;border-right: 1px solid #80808040;text-align: left;padding: 3px 0 3px 8px;font-size: 14px;' title='Delete'><i class='iconfa-retweet'></i>&nbsp;&nbsp;&nbsp;Restore</button></form>";
								}
								if($clients_per_delete == '1' && $user_type == 'admin' && $delete_clients_till_time > $current_date_time || $clients_per_delete == '1' && $user_type == 'superadmin' && $delete_clients_till_time > $current_date_time){ 
									$clientperdelete = "<li style='margin-bottom: 2px;'><form action='ClientPerDelete' onclick='return checkPreDelete()' method='post' target='_blank'><input type='hidden' name='c_id' value='".$row['c_id']."' /><input type='hidden' name='user_type' value='".$user_type."' /><button style='border-top: 1px solid #80808040;color: red;border-bottom: 1px solid #80808040;width: 160px;border-left: 1px solid #80808040;border-right: 1px solid #80808040;text-align: left;padding: 3px 0 3px 8px;font-size: 14px;' title='Permanent Delete'><i class='iconfa-trash'></i>&nbsp;&nbsp;&nbsp;Premanent Delete</button></form>";
								}
								else{
									$clientperdelete = "";
								}
										...
										"<tr class='gradeX' {$showw}>
											...
											<td>
												<table style='width: 100%;'>
													<tbody>
													<tr>
														<td class='' style='border-right: none;border-left: none;padding: 0px;width: 99%;'>
														<a href = '/web/'>	<b>{$row['c_id']}</b><br>{$row['c_name']}</b>{$passload}<br><a href='tel:{$row['cell']}'>{$row['cell']}</a>
														</td>
														<td class='' style='border-right: none;border-left: none;padding: 0;'>
														<div class='btn-group'>
															<button class='btn dropdown-toggle' style='border: 0px;font-size: 15px; background: none;color: #0866c6;padding: 8px 10px 8px;' title='Action' data-toggle='dropdown'><i class='iconfa-arrow-down'></i></button>
															<ul class='dropdown-menu' style='width: 160px;padding: 2px;left: unset;'>
																{$clientview}
																{$clientdeleteretarn}
																<li class='divider'></li>
																{$clientperdelete}
											...
											{$allimg}
											<td style='width: 15%;'><a href='Clients?id=all&zid={$row['z_id']}'><b>{$row['z_name']}</b></a><br>{$row['b_name']}<br>{$row['address']}<br><b>[{$row['Name']}]</b>{$onumac}</td>
								...
								elseif($type == 'macclient'){
									echo
										"<tr class='gradeX' {$showw}>
											...
											{$allimg}
											<td style='width: 15%;'><a href='Clients?id=macclient&zid={$row['zoneiddd']}'><b>{$row['z_name']}</b></a><br>{$row['b_name']}<br>{$row['address']}<br><b>[{$row['Name']}]</b>{$onumac}</td>
										...
										"<tr class='gradeX' {$showw}>
											...
											<td>
												<table style='width: 100%;'>
													...
													<tr>
														<td class='' style='border-right: none;border-left: none;padding: 0px;width: 99%;'>
															<b>{$row['c_id']}</b><br>{$row['c_name']}</b>{$passload}<br><a href='tel:{$row['cell']}'>{$row['cell']}</a>
														</td>
														<td class='' style='border-right: none;border-left: none;padding: 0;'>
														<div class='btn-group'>
															<button class='btn dropdown-toggle' style='border: 0px;font-size: 15px; background: none;color: #0866c6;padding: 8px 10px 8px;' title='Action' data-toggle='dropdown'><i class='iconfa-arrow-down'></i></button>
											...
											{$allimg}
											<td style='width: 15%;'><a href='Clients?id=all&zid={$row['zoneiddd']}'><b>{$row['z_name']}</b></a><br>{$row['b_name']}<br>{$row['address']}<br><b>[{$row['Name']}]</b>{$onumac}</td>
											<td>{$hhhh}<br><br><b>{$join_date}</b></td>
										...
										"<tr class='gradeX' {$showw}>
											...
											<td>
												<table style='width: 100%;'>
													...
													<tr>
														<td class='' style='border-right: none;border-left: none;padding: 0px;width: 99%;'>
														<a href = '/web/ClientView?id={$row['c_id']}'>	<b>{$row['c_id']}</b><br>{$row['c_name']}</b>{$passload}<br></a><a href='tel:{$row['cell']}'>{$row['cell']}</a>
														</td>
														<td class='' style='border-right: none;border-left: none;padding: 0;'>
														<div class='btn-group'>
															<button class='btn dropdown-toggle' style='border: 0px;font-size: 15px; background: none;color: #0866c6;padding: 8px 10px 8px;' title='Action' data-toggle='dropdown'><i class='iconfa-arrow-down'></i></button>
										...
										"<tr class='gradeX' {$showw}>
											...
											<td>
												<table style='width: 100%;'>
													...
													<tr>
														<td class='' style='border-right: none;border-left: none;padding: 0px;width: 99%;'>
															<b>{$row['c_id']}</b><br>{$row['c_name']}</b><br>{$row['pw']}<br><a href='tel:{$row['cell']}'>{$row['cell']}</a>
														</td>
														<td class='' style='border-right: none;border-left: none;padding: 0;'>
														<div class='btn-group'>
															<button class='btn dropdown-toggle' style='border: 0px;font-size: 15px; background: none;color: #0866c6;padding: 8px 10px 8px;' title='Action' data-toggle='dropdown'><i class='iconfa-arrow-down'></i></button>
