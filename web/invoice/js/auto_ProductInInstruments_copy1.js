...
$(".addmorenew").on('click',function(){
	...
	html += '<td class="center"><input type="text" style="width: 80%;font-size: 14px;font-weight: 700;text-align: center;" required="" name="quantity[]" class="changesNo form-control" id="quantity_'+aaa+'" style="width: 92%;font-weight: bold;" placeholder="" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"/></td>';
...
$(document).on('change keyup blur','.changesNo',function(){
	...
	number = document.getElementById("quantity_"+id[1]).value;
...
//		container.appendChild(document.createTextNode((i+1)));
		...
		input.type = "text";
		input.name = "slno_" + id[1] + "[]";
		input.required = "required=''";
		input.id = "slno_" + id[1];
		input.placeholder = itemName + " S/L No: " + (i+1);
		input.autocomplete = "off";
		input.style = "width: 92%;padding: 0px 4px 0px 4px;margin-bottom: 1px;text-align: center;";
