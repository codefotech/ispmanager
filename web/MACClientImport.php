		...
		<div class="box-header">
			<div class="modal-content">
				<div class="modal-header">
					...
					<form class="stdform" action="MACClientImportQuery" method="post" name="frmCSVImport" id="frmCSVImport" enctype="multipart/form-data">
						<input type="hidden" name="termination_date" value="<?php echo date('Y-m-d',strtotime("-1 days"));?>" />
