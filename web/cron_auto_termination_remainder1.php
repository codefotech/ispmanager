...
echo 'Remainder-1: Done<br>';
//header("Location:cron_auto_termination_remainder2.php");
$curls = curl_init();
$urlff = $weblink.'cron_auto_termination_remainder2.php';
