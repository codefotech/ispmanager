		...
		<div class="box-header">
			<div class="modal-content">
				<div class="modal-header">
					...
					<form id="form" class="stdform"  name="form" method="post" action="#" enctype="multipart/form-data">
						...
						<input type="hidden" name="entry_time" value="<?php echo date("Y-m-d h:i:s");?>" />
									...
									<div style="float: left;width: 45%;">
										<table class="table table-bordered table-invoice">
											<tr>
												...
												<td class="width70">
													<select data-placeholder="Choose a Vendor" name="vendor" style="font-weight: bold;" required="">
														<option value=""></option>
											...
											<tr>
												...
												<td>
													<select class="chzn-select" name="v_billadd" style="width:50%;float: left;text-align: center;font-size: 16px;font-weight: bold;" required="" onChange="getRoutePointVen(this.value)"> 
									...
									<div style="float: right;width: 45%;margin-right: 2%;">
										<table class="table table-bordered table-invoice">
											<tr>
												...
												<td class="width70">
													<select placeholder="" name="purchase_by" style="font-weight: bold;" required="">
														...
														<option value="<?php echo $rowss['e_id']?>"><?php echo $rowss['e_name'];?> - <?php echo $rowss['e_id'];?> (<?php echo $rowss['dept_name'];?>)</option>
															<?php } ?>
													</select>
												</td>
											</tr>
											<tr>
												...
												<td>
													<select class="chzn-select" name="exp_sts" style="width:50%;float: left;text-align: center;font-size: 16px;font-weight: bold;" required="" onChange="getRoutePointExp(this.value)"> 
														<option value="Yes">Yes</option>
														<option value="No" selected="selected">No</option>
													</select>
												</td>
							...
							<br/><br/>
										<table style="width:35%;font-size: 17px;height: 30px;margin-bottom: 3px;border-bottom: 5px solid #ff000021;">
											<tr>
												<td style="text-align:left;padding: 5px 0px 2px 15px;font-family: 'RobotoLight', 'Helvetica Neue', Helvetica, sans-serif;font-weight: bold; width: 50%;color: #ff0a0ac4;">Voucher No:</td>
												<td><input type="text" class="" name="" required="" placeholder="#" style="font-weight: bold;width: 75%;font-size: 20px;border-bottom: 3px solid #ff0a0ac4;border-top: 0px solid transparent;border-right: 0px solid transparent;border-left: 0px solid transparent;border-radius: 10px;margin-bottom: 5px;padding: 5px 0px 5px 15px;color: #00000087;" /><input type="hidden" name="purchase_date" readonly value="<?php echo date("Y-m-d");?>" required=""></td>
											</tr>										
										</table>
										...
										<table class="table responsive" style="border: 0;">
											<tr>
												<td style="width: 34%;border-bottom: 1px solid transparent;">
											...
											<tr>
												...
												<td style="width: 15%;border: 0;padding: 8px 0px 8px 30px;text-align: left;"><input type="text" style="width: 25px;font-weight: bold;font-size: 20px;border-radius: 5px 0 0 6px;border-right: 0;color: #58666e;height: 30px;text-align: center;" readonly value="৳"/><input type="text" style="width: 50%;font-weight: bold;font-size: 22px;border-radius: 0 5px 5px 0px;height: 30px;color: #d0430cc2;padding: 4px 4px 4px 10px;" name="total_price" required="" readonly id="totalAftertax" value="0.00" placeholder="" onkeypress="return IsNumeric(event);" readonly ondrop="return false;" onpaste="return false;"/></td>
											</tr>
										...
										<!--<p>
													...
													<span class="field"><textarea type="text" name="" style="width:100%;" id="" placeholder="Expense Note (If Any)" class="input-xxlarge" /></textarea></span>
												</p>--->
							</div>
							<div class="modal-footer">
								<button type="reset" class="btn ownbtn11">Reset</button>
...
<script src="invoice/js/auto_ProductInInstruments_copy.js"></script>
