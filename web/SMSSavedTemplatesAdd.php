...
$tempid = $_GET['tempid'];
if($tempid != ''){
$query2 = mysql_query("SELECT * FROM sms_msg WHERE id = '$tempid ' AND saved_template = '1' AND sts = '0'");
...
?>
	<div class="pageheader">
        ...
        <div class="pagetitle">
            <h1>SMS Saved Template <?php if($tempid != ''){echo 'Edit';}?></h1>
        </div>
    </div><!--pageheader-->
			        ...
			        <form id="form" class="stdform" method="post" action="SMSSavedTemplatesAddQuery">
                        <div class="messageright" style="margin: 0;min-height: 1185px;border-width: 0px;">
                            <div class="messageview">
									...
									<?php if($tempid != ''){ ?>
									<input type="hidden" value="edit" name="template_way"/>
								...
								<p>
									...
									<span class="field"><input type="text" name="template_name" required="" class="input-xlarge" value=<?php echo $row2['template_name'];?>></span>
								</p>
								<p>
									<label style="font-weight: bold;">Template For*</label>
									<span class="field">
										<select class="chzn-select" name="template_for" style="width: 38%;" required="" >
											<option value="Clients" <?php if ('Clients' == $row2['template_for']) echo 'selected="selected"';?>>Clients</option>
											<option value="Mac-Reseller" <?php if ('Mac-Reseller' == $row2['template_for']) echo 'selected="selected"';?>>Mac-Reseller</option>
											<option value="Employee" <?php if ('Employee' == $row2['template_for']) echo 'selected="selected"';?>>Employee</option>
										</select>
									</span>
								</p>
								<p>
									...
									<span class="field"><textarea type="text" name="sms_msg" id="sms_msg" style="width:90%;height: 476px;line-height: 30px;font-size: 16px;font-weight: bold;" required="" id="" placeholder="Write Your SMS Text Here" class="input-large" /><?php echo $row2['sms_msg'];?></textarea></span>
								</p>
								<br>
								<br>
								<br>
