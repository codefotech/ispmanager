...
$SQLSECS = mysql_query("SELECT c.c_id, c.com_id, c.c_name, z.z_name, c.address, c.cell, c.con_type, l.user_id, l.password, p.p_name, c.payment_deadline, c.mac_user, e.e_name FROM clients AS c
