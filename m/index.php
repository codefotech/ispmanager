         ...
         <p id="location"></p>
            ...
            <div class="forgot-pass">
              <label class="switch">
               ...
               <label style="position: relative;color: #666666;left: 5%;transform: translateY(-50%);vertical-align: middle;top: 12%;">Remember Me</label>
            </div>
            <button>LOGIN</button>
            <div class="sign-up">
               Not a member?
...
<div style="font-size: 40px;color: blue;font-weight: bold;text-align: center;margin-top: 70px;">Account has been</div> <div style="font-size: 40px;color: red;font-weight: bold;text-align: center;margin-top: 10px;">Terminated</div><div style="font-size: 20px;font-weight: bold;text-align: center;margin-top: 10px;">by</div> <div style="font-size: 25px;color: green;font-weight: bold;text-align: center;margin-top: 10px;"></div><div style="font-size: 17px;color: green;font-weight: bold;text-align: center;margin-top: 10px;">[Contact: No One ]</div>
</body>
</html>
