...
<html><body>     <form action="MacResellerPayment?id=<?php echo $z_id; ?>" method="post" name="ok">       <input type="hidden" name="sts" value="error">     </form>     <script language="javascript" type="text/javascript">		document.ok.submit();     </script></body></html>
<?php }
mysql_close($con);
?>