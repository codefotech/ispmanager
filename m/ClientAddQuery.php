...
//--------Add PPPoE in Mikrotik-------
		...
		if($new_id != ''){
			...
			if ($discount == ''){
				$dis_price = $pprice;
				$query2 = "insert into billing (c_id, bill_date, p_id, p_price, bill_amount, bill_date_time) VALUES ('$nombre', '$entry_date', '$p_id', '$pprice', '$pprice', '$bill_date_time')";
				...
				$query2 = "insert into billing (c_id, bill_date, p_id, p_price, discount, bill_amount, bill_date_time) VALUES ('$nombre', '$entry_date', '$p_id', '$pprice', '$discount', '$dis_price', '$bill_date_time')";
				if (!mysql_query($query2)){
					die('Error: ' . mysql_error());
				}
			}
			...
			if ($discount == ''){
				$query2 = "insert into billing (c_id, bill_date, p_id, p_price, discount, bill_amount, bill_date_time) VALUES ('$nombre', '$entry_date', '$p_id', '$pprice', '$discountt', '$unusedday', '$bill_date_time')";
				if (!mysql_query($query2)){
					die('Error: ' . mysql_error());
				}
			}
