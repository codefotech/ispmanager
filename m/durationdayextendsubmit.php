		...
		if($durations >= $minimum_day){
			if($daycost != '' || $dateee != ''){
				...
				<table style='width: 100%;'>
					<tr>
						<td style='border-left: none;border-right: none;vertical-align: middle;width: 100%;'>
							...
							<div style='color: green;font-size: 10px;font-weight: bold;line-height: 15px;' title='New Date'>NEW: <?php echo $dateee;?></div>
						</td>
						<td style='border-left: 1px solid #ddd;border-right: none;border-top: none;vertical-align: middle;'>
							<div style="text-align: center;color: #0866c6;line-height: 15px;font-size: 10px;">Recharge DONE [Activated]</div>
						</td>
					</tr>
				</table>
<?php	
					...
					$query2bb = "insert into billing_mac (c_id, z_id, p_id, start_date, start_time, end_date, days, p_price, bill_amount, entry_by, entry_date, entry_time) VALUES ('$clientid', '$z_id', '$p_id', '$aaaaw', '$update_time', '$Date2', '$duration', '$p_price', '$daycost', '$entry_by', '$update_date', '$update_time')";
						...
						<table style='width: 100%;'>
							<tr>
								...
								<td style='border-left: 1px solid #ddd;border-right: none;border-top: none;vertical-align: middle;'>
									<div style="text-align: center;color: #0866c6;line-height: 15px;font-size: 10px;">Recharge DONE</div>
								</td>
							</tr>
						</table>
<?php				}
