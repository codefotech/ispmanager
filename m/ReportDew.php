...
?>
	<div class="box box-primary">
			<div class="box-body aasas"> 
				...
				<form id="" name="form" class="stdform" method="post" action="fpdf/ReportDew" target="_blank">
									...
									<div class="inputwrapper1 animate_cus4">
										<input type="text" name="f_date" id="" class="datepicker" style="width: 47%;" value="<?php echo date('Y-m-01', time());?>" placeholder="From Date"/>
										<input type="text" name="t_date" id="" class="datepicker" style="width: 47%;" value="<?php echo date('Y-m-d', time());?>" placeholder="To Date"/>
									</div>
