...
<body>
<div class="login">
	<img src="images/logo22.png" height="105px" width="300px" style="margin-bottom: 20px;" />
    <form id="login" action="login_exec" method="post">
    	<input type="text" name="username" id="login" placeholder="User ID" required="required" />
