...
$bkbank=$rowbk['bank'];
	...
	$sqlmqq = mysql_query("SELECT p.id AS mrno, z.z_name, c.cell, c.bandwidth, c.ip, c.mac, x.mk_profile, c.z_id, c.c_name, p.bill_discount, p.pay_ent_by, c.c_id FROM payment as p
